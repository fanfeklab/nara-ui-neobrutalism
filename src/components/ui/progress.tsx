  ...
  "h-full w-full flex-1 border-r-2 border-black transition-all",
  {
    variants: {
      variant: {
        ...
        striped:
          "bg-primary bg-[linear-gradient(45deg,rgba(0,0,0,0.1)_25%,transparent_25%,transparent_50%,rgba(0,0,0,0.1)_50%,rgba(0,0,0,0.1)_75%,transparent_75%,transparent)] bg-[length:1rem_1rem]",
      },
    },
    defaultVariants: {
      variant: "default",
