        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="bg-card border-4 border-black rounded-3xl p-8 md:p-12 shadow-brutal">
              <div className="flex items-center gap-4 mb-8 border-b-4 border-black pb-4">
                 ...
                 <h2 className="text-3xl font-display font-black uppercase tracking-tighter">Frequently Asked Questions</h2>
              </div>
              
              <Accordion type="single" collapsible className="w-full flex flex-col gap-4">
                {faq.map((item, i) => (
                  <AccordionItem key={i} value={`item-${i}`} className="border-4 border-black rounded-2xl bg-card  px-6 shadow-brutal-sm">
