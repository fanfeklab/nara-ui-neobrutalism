          ...
          <div className="flex gap-2 p-1 bg-muted border-2 border-black rounded-xl overflow-auto w-full md:w-auto hidescrollbar">
            <Button
              ...
              className={cn(
                ...
                statusFilter === "all" && "bg-black text-white hover:bg-black",
              )}
              onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {allEvents.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="group flex flex-col bg-card border-4 border-black rounded-2xl overflow-hidden shadow-brutal hover:-translate-y-2 transition-transform"
                  >
                    <div className="aspect-[3/2] border-b-4 border-black relative overflow-hidden bg-muted">
                      ...
                      <div
                        className={cn(
                          "absolute top-3 left-3 text-white font-display font-black text-xs uppercase px-2 py-1 border-2 border-black rounded-lg shadow-brutal-sm",
                          isUpcoming ? "bg-secondary" : "bg-black",
                        )}
                      >
                        {item.category}
                      </div>
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <div className="mt-auto border-t-2 border-black pt-4">
                        <Button
                          ...
                          variant="outline"
                          className={cn(
                            "w-full rounded-xl font-bold uppercase transition-all shadow-brutal-sm",
                            isUpcoming &&
                              "hover:bg-primary hover:text-black border-2 border-black",
                          )}
                        >
