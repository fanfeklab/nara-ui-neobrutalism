        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <article className="prose prose-lg dark:prose-invert max-w-none font-body prose-headings:font-display prose-headings:font-black prose-headings:uppercase prose-headings:tracking-tighter prose-a:text-primary prose-a:font-bold prose-ul:list-none prose-ul:pl-0 prose-li:flex prose-li:items-start prose-li:gap-3 prose-li:mb-2 prose-strong:text-secondary dark:prose-strong:text-primary">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: serviceItem.body_html
                    .replace(
                      /<li>/g,
                      '<li><svg class="w-6 h-6 text-accent shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><div>',
                    )
                    .replace(/<\/li>/g, "</div></li>"),
                }}
              />
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-28">
            <div className="flex flex-col gap-8 p-8 border-4 border-black rounded-2xl bg-primary text-black shadow-brutal">
              <h3 className="font-display font-black text-2xl uppercase tracking-tight border-b-2 border-black pb-2">
                Klaim Terbesar
              </h3>
              ...
              <div className="mt-4 pt-6 border-t-2 border-black flex flex-col gap-4">
                <h4 className="font-display font-black uppercase text-lg">
                  Tertarik Dengan Layanan Ini?
                </h4>
                <p className="font-body text-sm font-medium opacity-80">
                  Jadwalkan konsultasi dengan tim operasional kami sekarang.
                </p>
                <Button
                  asChild
                  size="lg"
                  className="w-full h-14 bg-black text-white hover:bg-card hover:text-black border-2 border-black rounded-xl font-display font-black text-lg uppercase tracking-tight shadow-brutal-sm hover:translate-x-1 transition-all mt-2"
                >
