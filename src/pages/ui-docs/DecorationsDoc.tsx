  ...
  return (
    <div className="space-y-10">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-display font-bold border-b-2 border-black pb-2">Sparkle</h2>
        <p className="font-body text-muted-foreground">Standard 4-point star used for accents and pop-ups.</p>
...
export function SparkleDemo() {
  return (
    <div className="flex gap-4">
      ...
      {/* Marquee */}
      <section className="space-y-4">
        <h2 className="text-2xl font-display font-bold border-b-2 border-black pb-2">Marquee</h2>
        <p className="font-body text-muted-foreground">Endless scrolling text. Ideal for banners or footers.</p>
        <Tabs defaultValue="preview">
          <TabsList>
            <TabsTrigger value="preview">Preview</TabsTrigger>
            <TabsTrigger value="code">Code</TabsTrigger>
          </TabsList>
          <TabsContent value="preview" className="border-2 border-black rounded-xl overflow-hidden shadow-brutal bg-card">
            <div className="py-8">
          ...
          <TabsContent value="code">
            <CodeBlock language="tsx" code={`import { Marquee } from "@/components/decorations/Marquee";
...
export function MarqueeDemo() {
  return (
    <div className="space-y-4">
      ...
      {/* Abstract Blob */}
      <section className="space-y-4">
        <h2 className="text-2xl font-display font-bold border-b-2 border-black pb-2">Abstract Blob</h2>
        <p className="font-body text-muted-foreground">Floating blobs used to create depth or as background elements.</p>
        <Tabs defaultValue="preview">
          <TabsList>
            <TabsTrigger value="preview">Preview</TabsTrigger>
            <TabsTrigger value="code">Code</TabsTrigger>
...
export function BlobDemo() {
  return (
    <div className="flex gap-4">
      ...
      {/* Wave */}
      <section className="space-y-4">
        <h2 className="text-2xl font-display font-bold border-b-2 border-black pb-2">Wave</h2>
        <p className="font-body text-muted-foreground">Animated wave shape patterns useful for connecting sections or dynamic backgrounds.</p>
        <Tabs defaultValue="preview">
          <TabsList>
            <TabsTrigger value="preview">Preview</TabsTrigger>
            <TabsTrigger value="code">Code</TabsTrigger>
