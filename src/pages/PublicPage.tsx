  ...
  return (
    <div className="w-full">
      ...
      <section className="relative w-full overflow-hidden bg-[#FDFBD4] border-b-2 border-black dark:bg-[#0a192f]">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6 lg:px-8 py-24 md:py-32 lg:py-40 flex flex-col items-center text-center max-w-7xl">
      ...
      <section className="w-full py-24 bg-card border-b-2 border-black">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            {/* 1 Big Featured Card */}
            <div className="lg:col-span-8 group bg-background border-4 border-black rounded-2xl overflow-hidden shadow-brutal flex flex-col hover:-translate-y-2 hover:shadow-[12px_12px_0_0_#000] transition-all h-full">
              <div className="relative aspect-video lg:aspect-auto border-b-4 border-black overflow-hidden flex-1 min-h-[300px] lg:min-h-[400px]">
              ...
              <div className="p-6 md:p-8 bg-white dark:bg-[#112240] flex flex-col gap-4">
                ...
                <p className="font-body font-medium mt-2 mb-4 line-clamp-2 text-sm md:text-base">
      ...
      <section className="w-full py-16 bg-[#112240] text-white border-b-2 border-black overflow-hidden relative">
          <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl text-center mb-8">
